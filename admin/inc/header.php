<div class="container-fluid bg-dark text-light p-3 d-flex align-items-center justify-content-between sticky-top">
    ...
    <div class="col-lg-2 bg-dark border-top border-3 border-secondary text-white" id="dashboard-menu">
        <nav class="navbar navbar-expand-lg navbar-light rounded shadow bg-dark">
            <div class="container-fluid flex-lg-column align-items-stretch">
                <h5 class="mt-2">ADMIN PANEL</h5>
                <button class="navbar-toggler shadow-none" type="button" style="border-color: white; color:white" data-bs-toggle="collapse" data-bs-target="#adminDropdown" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
